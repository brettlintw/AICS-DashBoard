...
st.title("🌐 AICS 北美部署決策中心 (V8.13 最終穩定列印版)")
...
if uploaded_file:
    ...
    # 加入列印按鈕
    st.sidebar.markdown("""
        <button onclick="window.print()" style="width: 100%; padding: 10px; background-color: #007BFF; color: white; border: none; border-radius: 5px; cursor: pointer; font-weight: bold;">
            🖨️ 匯出 PDF 報告 (列印/另存)
        </button>
    """, unsafe_allow_html=True)
