...
# 1. 頁面設定
st.set_page_config(layout="wide", page_title="AICS 北美部署決策中心 V8.1")
...
if uploaded_file:
    ...
    fig_map.update_layout(
        geo=dict(
            ...
            center=dict(lat=38, lon=-100), # 北美中心
            projection_scale=1.5
        ),
        height=800, margin={"r":0,"t":0,"l":0,"b":0}, legend=dict(font=dict(size=20))
    )
