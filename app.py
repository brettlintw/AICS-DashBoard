...
# --- 雲端數據讀取模組 ---
SHEET_ID = "請填入您的GoogleSheetsID" # 修改此處
...
df = load_data()
if df is None:
    st.warning("https://docs.google.com/spreadsheets/d/1AQNSCVWVoY9dFWD4NdCmXRWiRQt0--LE/edit?usp=sharing&ouid=101935051207867221848&rtpof=true&sd=true")
    st.stop()
